    ...
    <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">1. Introduction</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">2. Information We Collect</h2>

          <h3 className="text-lg font-display font-bold text-text-base mb-3">Personal Information</h3>
          <p className="text-md text-text-secondary mb-4">
          ...
          <h3 className="text-lg font-display font-bold text-text-base mb-3">Automatically Collected Information</h3>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">3. How We Use Your Information</h2>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">4. Information Sharing</h2>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">5. Data Security</h2>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">6. Data Retention</h2>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">7. Your Rights</h2>
          <p className="text-md text-text-secondary mb-4">
          ...
          <p className="text-md text-text-secondary mb-4">
            ...
            <a href="mailto:privacy@offmarket.co.nz" className="text-accent hover:text-accent-hover underline">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">8. Cookies</h2>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">9. Third-Party Links</h2>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">10. Children&apos;s Privacy</h2>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">11. Changes to This Policy</h2>
          <p className="text-md text-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-display font-bold text-text-base mb-4 mt-8">12. Contact Us</h2>
          <p className="text-md text-text-secondary mb-4">
      ...
      <div className="border-t border-border mt-8 pt-8 flex gap-4">
