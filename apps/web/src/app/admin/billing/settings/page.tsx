    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <Link href="/admin/billing" className="text-text-secondary hover:text-text-base">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
          </Link>
          <h1 className="text-xl font-display font-semibold text-text-base">Billing Settings</h1>
        </div>
        <div className="card">
          <div className="animate-pulse space-y-4">
            <div className="h-8 bg-surface-raised rounded w-1/4" />
    ...
    <div className="space-y-6">
      ...
      {success && (
        <div className="card border-l-4 border-success">
          <p className="text-sm text-text-base">Settings saved successfully!</p>
        </div>
      )}
      ...
      <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <label className="flex items-center gap-2 mt-2">
                ...
                />
                <span className="text-sm text-text-secondary">Enable yearly billing</span>
              </label>
            </div>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  <th className="text-left py-3 px-4 font-medium text-text-base">Feature</th>
                  <th className="text-center py-3 px-4 font-medium text-text-secondary">
                    <span className="inline-flex items-center gap-1">
                      Free
                    </span>
                  </th>
                  <th className="text-center py-3 px-4 font-medium text-accent">
                    <span className="inline-flex items-center gap-1">
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Buyer Interest Limit</p>
                      <p className="text-sm text-text-secondary">Maximum number of buyer interests</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    ...
                    />
                    <p className="text-xs text-text-muted mt-1">{formatLimit(settings.freeFeatures.wantedAdLimit)}</p>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                      type="number"
                      ...
                      className="input w-20 text-center tabular-nums"
                    />
                    <p className="text-xs text-text-muted mt-1">{formatLimit(settings.proFeatures.wantedAdLimit)}</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Saved Search Limit</p>
                      <p className="text-sm text-text-secondary">Maximum saved searches</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                      ...
                      className="input w-20 text-center tabular-nums"
                    />
                    <p className="text-xs text-text-muted mt-1">{formatLimit(settings.freeFeatures.savedSearchLimit)}</p>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                      type="number"
                      ...
                      className="input w-20 text-center tabular-nums"
                    />
                    <p className="text-xs text-text-muted mt-1">{formatLimit(settings.proFeatures.savedSearchLimit)}</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Specific Address Interests</p>
                      <p className="text-sm text-text-secondary">Max specific property interests (-1 = unlimited)</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Priority Notifications</p>
                      <p className="text-sm text-text-secondary">Get notified before other users</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Early Access</p>
                      <p className="text-sm text-text-secondary">Early access to new properties</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Match Notifications</p>
                      <p className="text-sm text-text-secondary">Get notified of property matches</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Direct Messaging</p>
                      <p className="text-sm text-text-secondary">Message property owners/buyers</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Postcard Direct Mail</p>
                      <p className="text-sm text-text-secondary">Send physical postcards to owners</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
                ...
                <tr>
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-text-base">Free Postcards/Month</p>
                      <p className="text-sm text-text-secondary">Monthly free postcard allowance</p>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-center">
                    <input
        ...
        <div className="card">
          ...
          <div className="mb-6 card-compact bg-surface-raised">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="card-compact">
              <div className="flex items-center justify-between mb-3">
                <span className="font-medium text-text-base">Standard</span>
            ...
            <div className="card-compact border-accent">
              <div className="flex items-center justify-between mb-3">
                <span className="font-medium text-text-base">Premium</span>
            ...
            <div className="card-compact border-warning">
              <div className="flex items-center justify-between mb-3">
                <span className="font-medium text-text-base">Luxury</span>
                <span className="badge-warning tabular-nums">
      ...
      <div className="card">
        ...
        <ul className="space-y-2 text-sm text-text-secondary">
          ...
          <li className="flex items-start gap-2">
            <svg className="w-4 h-4 text-warning mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
